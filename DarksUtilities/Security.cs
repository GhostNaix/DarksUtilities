...
namespace DarksUtilities
{
    public class Security
    {
        ...
        public static unsafe void Initialize()
        {
            ...
            {
                MessageBox.Show("An HTTP Debugger has been detected on your computer, please remove it before using this app!", "DarksUtilities - https://cto.d4rk.fr", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public static bool checkMD5(string url)
        {
            ...
            {
                MessageBox.Show("Hash check failed, exiting...", "DarksUtilities - https://cto.d4rk.fr/", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Environment.Exit(0);
                return false;
            }
        }
