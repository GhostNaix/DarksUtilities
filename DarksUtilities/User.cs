...
namespace DarksUtilities
{
    public class User
    {
        public static string getIP()
        {
            if(!hasInternet())
            {
                MessageBox.Show("This application requires an internet connection, please verify your internet connection!", "DarksUtilities - https://cto.d4rk.fr/", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Environment.Exit(0);
            }
            string ip;
